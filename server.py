...
@app.route("/")
def hello_world():
    return '<p>Hello, World!</p><p><a href="http://10.0.0.110/get_status">Get Status</a></p><p><a href="http://10.0.0.110/start_scan">Start Scan</a></p><p><a href="http://10.0.0.110/get_data">Get Data</a></p>'
